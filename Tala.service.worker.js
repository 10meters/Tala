...
/** @type {string} */
const CACHE_VERSION = '1723814642|689288794';
/** @type {string} */
const CACHE_PREFIX = 'Tala-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Tala.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Tala.html","Tala.js","Tala.offline.html","Tala.icon.png","Tala.apple-touch-icon.png","Tala.worker.js","Tala.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Tala.wasm","Tala.pck"];
